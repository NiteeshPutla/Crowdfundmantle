...
function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const contract = "0x8dCC15EC2573D5a797B40227837714D95B24185e";
  ...
  return (
    <div className="App">
      ...
      <div className="text-center">
        {getNetwork != "3141"
          ? "Please make sure you're on the Mantle test network"
          : mmStatus}
      </div>
      <hr />
      ...
      {/* Footer mantle content */}
      <footer className="footer">
       Developed for Ethall hackathon by Niteesh
